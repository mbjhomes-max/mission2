...
export default function App() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      await addDoc(collection(db, 'leads'), data).catch(error => handleFirestoreError(error, OperationType.CREATE, 'leads'));
      ...
      }).catch(error => handleFirestoreError(error, OperationType.CREATE, 'mail'));
